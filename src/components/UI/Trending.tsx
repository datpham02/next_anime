...
import PreArrow from '../Slider/PreArrow'
                    ...
                    <Slider {...settingSlider}>
                        {isSuccess
                            ? data?.results.map(
                                  (
                                      ...
                                      return (
                                          ...
                                          >
                                              <div className='pr-[10px] select-none'>
                            ...
                            : Array.from(new Array(20)).map(() => (
                                  <div className='w-full h-full pr-[10px] select-none skeleton'></div>
                              ))}
                    </Slider>
                </div>
            </div>
