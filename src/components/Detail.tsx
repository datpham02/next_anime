...
const Detail = () => {
    ...
    const wrappedDetailDivRef = useRef<HTMLDivElement>(null)

    useEffect(() => {
        window.addEventListener('scroll', function () {
            if (wrappedDetailDivRef && wrappedDetailDivRef.current) {
                if (bgImageRef && bgImageRef.current) {
                    bgImageRef.current.style.width = `${wrappedDetailDivRef.current.clientWidth}px`
                    bgImageRef.current.style.height = `${wrappedDetailDivRef.current.clientHeight}px`
                }
            }
        })
    }, [])
        ...
        <>
            <div className='w-full h-full'>
                <div className='relative w-full'>
                    ...
                    />
                    <div className='absolute flex xl:flex-row flex-col xl:space-y-0 space-y-4 top-0 left-0 w-full bg-[rgba(0,0,0,0.4)]'>
                        <div
                            ref={wrappedDetailDivRef}
                            className='flex sm:flex-row sm:items-start sm:space-x-6 sm:space-y-0 sm:px-[20px] flex-col space-y-6 justify-center items-center  py-[100px]'
                        >
                            <img
                            ...
                            <div className='flex flex-col space-y-6'>
                                <h1 className='sm:text-left text-center text-[#fff] font-medium 2xl:text-[60px] xl:text-[40px] lg:text-[35px] md:text-[30px] sm:text-[20px] text-[22px]'>
                        ...
                        <div className='w-full bg-[rgba(255,255,255,.1)] text-[#fff] sm:text-[14px] text-[13px] font-medium xl:py-[100px] py-[40px] px-[25px]'>
                            ...
                            <div className='border-b-solid border-b-[1px] border-b-[#594B51] py-[10px] space-y-2'>
                                <div>
                                    <span>Japanese:</span>
                                    <span></span>
                                </div>
