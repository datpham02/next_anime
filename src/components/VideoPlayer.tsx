...
const VideoPlayer = () => {
    ...
    useEffect(() => {
        if (videoRef.current != null) {
            ...
            video.setAttribute('src', 'access/video.mp4')
    ...
    const handleVolumeVideo = (e: any) => {
        ...
        if (videoVolumeRef && videoVolumeRef.current) {
            ...
            if (clientX >= min && clientX <= max) {
                ...
                if (videoRef && videoRef.current) {
                    if (Math.floor(percent * 100) <= 3) {
                        videoRef.current.volume = 0
                    } else videoRef.current.volume = percent

                    setVideoVolume(
                        Math.floor(percent * 100) >= 3
            ...
            >
                ...
                >
                    ...
                    <div className='flex items-center gap-4'>
                        ...
                        {/* <GiNextButton className='text-[#fff] text-[25px]' /> */}
                        {videoVolume > 0 ? (
                            <IoMdVolumeLow className='text-[#fff] text-[25px]' />
                        ) : (
                            <IoMdVolumeMute className='text-[#fff] text-[25px]' />
                        )}
                        <div
                            ref={videoVolumeRef}
                            onMouseDown={() => {
                        ...
                        <AiTwotoneSetting className='text-[#fff] text-[25px]' />
                    </div>
                </div>
            </div>
        </>
